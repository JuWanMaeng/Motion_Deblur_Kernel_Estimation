...
def create_msg_model(guidance_ch, learn_sigma, use_scale_shift_norm, dropout, model_path,):
    
    model = UNet_MSG(in_channels=6, guidance_channels=guidance_ch,learn_sigma=learn_sigma, use_scale_shift_norm=use_scale_shift_norm, dropout=dropout)
