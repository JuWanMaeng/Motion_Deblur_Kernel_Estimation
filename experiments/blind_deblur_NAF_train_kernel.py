...
def main():
    ...
    measurement_cond_fn = cond_method.conditioning_train
    ...
    sample_fn = partial(sampler.p_sample_loop_gt, model=model, measurement_cond_fn=measurement_cond_fn)
   
    # Prepare dataloader

    sharp_files = glob.glob(f'/raid/joowan/split_train_gopro/part2/sharp/*.png')
    ...
    for i, images in enumerate(loader):
        ...
        sharp_img = F.pad(sharp_img, (0, pad_w, 0, pad_h), mode='reflect')
