...
def main():
    ...
    parser.add_argument('--save_dir', type=str, default='./results/FFHQ_16')
    # Regularization
    ...
    for i, ref_img in enumerate(loader):
        ...
        y = operator.forward(ref_img, kernel)   ### y: k*x0  임의의 블러 커널로 블러 이미지 생성
        y_n = noiser(y)   ### y * noise(0.02)   ### 가우시안 노이즈...??? 왜?
